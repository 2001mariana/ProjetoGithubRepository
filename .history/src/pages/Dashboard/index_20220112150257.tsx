...
export const Dashboard: React.FC = () => {
  ...
  async function handleAddRepo(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    setRepos([...repos, repository])//utilizei ...repos para manter tudo que já existe na lista repos e adicionando repository. Caso eu alterasse o estado passando apenas repository eu estaria substituindo tudo que tem no estado.
  }
  return (
    <>
